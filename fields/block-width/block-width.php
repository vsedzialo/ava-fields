...
if ( ! class_exists( 'AVA_Field_Block_Width' ) ) {
     ...
     */
	class AVA_Field_Block_Width extends \AVAFields\Core\Abstracts\Field {
		...
		public function build() {
            ...
            // Width (px)
            $this->html .= '&nbsp;<input type="text" class="block-width-pixels" name="' . $this->id . '-pixels" id="' . $this->id . '-pixels" value="' . esc_attr( $field_value['pixels'] ) . '" ><span class="avaf-after">'.__('px', '{domain}').'</span>';
