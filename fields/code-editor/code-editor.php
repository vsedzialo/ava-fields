...
if (!class_exists( 'AVA_Field_Code_Editor' )) {
     ...
     */
	class AVA_Field_Code_Editor extends \AVAFields\Core\Abstracts\Field
	{
		...
		public function load_assets() {
            ...
            AVA_Fields()->add_style( 'avaf-codemirror', $this->field_url . 'assets/codemirror/codemirror.css' );
            AVA_Fields()->add_script( 'avaf-codemirror', $this->field_url . 'assets/codemirror/codemirror.js' );
            AVA_Fields()->add_script( 'avaf-codemirror-mode-javascript', $this->field_url . 'assets/codemirror/javascript.js' );
		}
