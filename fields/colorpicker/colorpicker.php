...
if (!class_exists( 'AVA_Field_Colorpicker' )) {
     ...
     */
	class AVA_Field_Colorpicker extends \AVAFields\Core\Abstracts\Field
	{
		...
		public function load_assets() {
            AVA_Fields()->add_script( 'avaf-colorpicker', $this->field_url . 'assets/colpick/colpick.js' );
            AVA_Fields()->add_style( 'avaf-colorpicker', $this->field_url . 'assets/colpick/colpick.css' );
		}
