...
if ( ! class_exists( 'AVA_Field_Block_Layout' ) ) {
     ...
     */
	class AVA_Field_Block_Layout extends \AVAFields\Core\Abstracts\Field {
		...
		public function build() {
            ...
            $this->html = '<div class="avaf-block-layout">';
                ...
                $this->html .= '<div class="bl-margin">';
                    $this->html .= '<div class="legend">'.__('margin', '{domain}').'</div>';
                    ...
                    $this->html .= '<div class="bl-row bl-row2">';
                        ...
                        $this->html .= '<div class="bl-border">';
                            $this->html .= '<div class="legend">'.__('border', '{domain}').'</div>';
                            ...
                            $this->html .= '<div class="bl-row bl-row2">';
                                ...
                                $this->html .= '<div class="bl-padding">';
                                    $this->html .= '<div class="legend">'.__('padding', '{domain}').'</div>';
			...
			$this->params['options'] = [
                'full' => __('Full width', '{domain}'),
                'fixed' => __('Fixed width', '{domain}'),
            ];
            ...
            // Width (px)
            $this->html .= '<br><input type="text" class="block-width-pixel" name="' . $this->id . '-width" id="' . $this->id . '-pixel" value="' . esc_attr( $field_value['pixel'] ) . '" ><span class="avaf-after">'.__('px', '{domain}').'</span>';
